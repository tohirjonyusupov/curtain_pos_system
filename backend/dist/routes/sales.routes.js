...
const createSale_1 = require("../controllers/sales/createSale");
const getSales_1 = require("../controllers/sales/getSales");
const getSaleById_1 = require("../controllers/sales/getSaleById");
 ...
 */
salesRouter.post("/", createSale_1.createSale);
/**
 * @openapi
 * /sales:
 *   get:
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
salesRouter.get("/", getSales_1.getSales);
/**
 * @openapi
 * /sales/{id}:
 *   get:
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
salesRouter.get("/:id", getSaleById_1.getSaleById);
